...
class CertificateParameters(BaseModel):
    APPNO: str = Field(
        ..., description='Registration Application No', examples=['REG1307241']
    )
    Date_Of_Birth: str = Field(
        ..., description='Date Of Birth', examples=['11-11-1990']
    )
    ENROLNO: str = Field(
        ..., description='Enrollment No.', examples=['41C172C17OCT1203']
    )
    TypOfCert: str = Field(
        ...,
        description='Type Of Service',
        examples=[
            'Registration Certificate&#x28;PREGC&#x29;,Duplicate Registration Certificate&#x28;PDURC&#x29;,Good S'
        ],
    )
...
class SocerCertificatePostRequest(BaseModel):
...
class SocerCertificatePostResponse(BaseModel):
...
class SocerCertificatePostResponse1(BaseModel):
...
class SocerCertificatePostResponse2(BaseModel):
...
class SocerCertificatePostResponse3(BaseModel):
...
class SocerCertificatePostResponse4(BaseModel):
...
class SocerCertificatePostResponse5(BaseModel):
...
class SocerCertificatePostResponse6(BaseModel):
